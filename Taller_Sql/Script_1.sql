...
-- -----------------------------------------------------
-- Se realiza dos borrados lógicos y dos borrados físicos de ventas realizadas
-- -----------------------------------------------------
UPDATE store_sale 
SET date_store_sale = now()
WHERE id_store_sale = 1;

UPDATE store_sale 
SET date_store_sale = now()
WHERE id_store_sale = 2;

DELETE FROM store_sale
WHERE id_store_sale = 5;

DELETE FROM store_sale
WHERE id_store_sale = 6;


-- -----------------------------------------------------
-- Modificación de tres productos en su nombre y los datos del proveedor
-- -----------------------------------------------------
UPDATE product SET name_product = 'shampoo' WHERE id_product = 1;
UPDATE product SET name_product = 'tomate' WHERE id_product = 4;
UPDATE product SET name_product = 'refresco' WHERE id_product = 6;
UPDATE provider SET name = 'manuel', last_name = 'mejia' WHERE id_provider = 1;